...
<template>
    <div class="nexo-logo-wrapper" v-bind="$attrs">
        <div class="nexo-hexagon-container" :style="{ width: props.width, height: props.height }">
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="vueGradLeft" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="#00ffff" />
                        <stop offset="100%" stop-color="#4a00e0" />
                    </linearGradient>
                    <linearGradient id="vueGradRight" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="#ff00ff" />
                        <stop offset="100%" stop-color="#4a00e0" />
                    </linearGradient>
                    <linearGradient id="vueGradBot" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="#2a1b54" />
                        <stop offset="100%" stop-color="#140a2e" />
                    </linearGradient>
                </defs>

                <polygon class="nexo-panel nexo-panel-left" points="100,10 20,55 20,145 100,150" fill="url(#vueGradLeft)" />
                <polygon class="nexo-panel nexo-panel-right" points="100,10 180,55 180,145 100,150" fill="url(#vueGradRight)" />
                <polygon class="nexo-panel nexo-panel-bot-left" points="20,145 100,190 100,150" fill="url(#vueGradBot)" />
                <polygon class="nexo-panel nexo-panel-bot-right" points="180,145 100,190 100,150" fill="url(#vueGradBot)" />
        ...
        <div v-if="props.showText" class="nexo-text-container" :style="{ fontSize: `calc(${props.height} * 0.4)` }">
