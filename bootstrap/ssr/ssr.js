...
createServer((page) => createInertiaApp({
	...
	resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({
		"./Pages/Admin/Asambleas/Index.vue": () => import("./assets/Index-B1PiU37i.js"),
		"./Pages/Admin/Copropiedades/Create.vue": () => import("./assets/Create-BioirgpY.js"),
		"./Pages/Admin/Logs/Index.vue": () => import("./assets/Index-EHTKcWMD.js"),
		"./Pages/Admin/Pqrs/Index.vue": () => import("./assets/Index-OHej0u6s.js"),
		"./Pages/Admin/Reservas/Manager.vue": () => import("./assets/Manager-DPycjGb6.js"),
		"./Pages/Admin/Settings/Index.vue": () => import("./assets/Index-BqscHnEd.js"),
		"./Pages/Admin/Zonas/Index.vue": () => import("./assets/Index-CYbRZ9sp.js"),
		"./Pages/Asamblea/AccessDenied.vue": () => import("./assets/AccessDenied-DCKELK8D.js"),
		"./Pages/Asamblea/Show.vue": () => import("./assets/Show-BQRU-62k.js"),
		"./Pages/Auth/Login.vue": () => import("./assets/Login-fdN1L7BB.js"),
		"./Pages/Auth/Onboarding.vue": () => import("./assets/Onboarding-CUnuB27v.js"),
		"./Pages/Auth/SetupTwoFactor.vue": () => import("./assets/SetupTwoFactor-BkEc3jk6.js"),
		"./Pages/Auth/TwoFactorChallenge.vue": () => import("./assets/TwoFactorChallenge-COF3YODw.js"),
		"./Pages/Cartera/Index.vue": () => import("./assets/Index-CDkokzV-.js"),
		"./Pages/Dashboard.vue": () => import("./assets/Dashboard-BU_TWFNu.js"),
		"./Pages/Error/LicenseSuspended.vue": () => import("./assets/LicenseSuspended-Cxi0-KEd.js"),
		"./Pages/Legal/Consent.vue": () => import("./assets/Consent-dCtssPF_.js"),
		"./Pages/Legal/Privacy.vue": () => import("./assets/Privacy-D0Fysz7u.js"),
		"./Pages/Legal/Terms.vue": () => import("./assets/Terms-BWltZ9_H.js"),
		"./Pages/Owner/Dashboard.vue": () => import("./assets/Dashboard-Dq_AIRzT.js"),
		"./Pages/Owner/Payments/Index.vue": () => import("./assets/Index-D1IZPMnC.js"),
		"./Pages/Owner/Pqrs/Index.vue": () => import("./assets/Index-BXfqWzbA.js"),
		"./Pages/Owner/Reservas/Index.vue": () => import("./assets/Index-CWil3pYQ.js"),
		"./Pages/Profile/Edit.vue": () => import("./assets/Edit-BHhQcqDl.js"),
		"./Pages/SuperAdmin/Announcements/Index.vue": () => import("./assets/Index-B2pl9DO5.js"),
		"./Pages/SuperAdmin/Audit/Index.vue": () => import("./assets/Index-D7JlbwM7.js"),
		"./Pages/SuperAdmin/Dashboard.vue": () => import("./assets/Dashboard-DBD6DgkC.js"),
		"./Pages/SuperAdmin/Legal/Create.vue": () => import("./assets/Create-C9iZaNsw.js"),
		"./Pages/SuperAdmin/Legal/Index.vue": () => import("./assets/Index-DBt3SooN.js"),
		"./Pages/SuperAdmin/Licenses/Index.vue": () => import("./assets/Index-3PdmM7oO.js"),
		"./Pages/SuperAdmin/Licenses/Management.vue": () => import("./assets/Management-DdxaLnV2.js"),
		"./Pages/SuperAdmin/Settings/Index.vue": () => import("./assets/Index-BoCHY6Py.js"),
		"./Pages/SuperAdmin/Support/Index.vue": () => import("./assets/Index-DdBNArnp.js"),
		"./Pages/SuperAdmin/Users/Index.vue": () => import("./assets/Index-BpmCNhgv.js"),
		"./Pages/Support/Index.vue": () => import("./assets/Index-DyHa6MqE.js"),
		"./Pages/Welcome.vue": () => import("./assets/Welcome-CsMXoubH.js")
	})),
	setup({ App, props, plugin }) {
		const vueApp = createSSRApp({ render: () => h(App, props) });
		vueApp.use(plugin).use(M, {
			...page.props.ziggy || {},
			location: page.props.ziggy?.location ? new URL(page.props.ziggy.location) : void 0
		});
