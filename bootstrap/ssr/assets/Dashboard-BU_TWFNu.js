...
import { t as Dropdown_default } from "./Dropdown-4qzJ-Us7.js";
import { computed, createTextVNode, createVNode, defineAsyncComponent, defineComponent, toDisplayString, unref, useSSRContext, withCtx } from "vue";
...
var Dashboard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div class="space-y-12 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700" data-v-acbde70c><div class="flex flex-col lg:flex-row lg:items-end justify-between gap-8" data-v-acbde70c><div class="space-y-2" data-v-acbde70c><div class="flex items-center gap-3" data-v-acbde70c><div class="w-1.5 h-6 bg-primary rounded-full" data-v-acbde70c></div><h2 class="text-[10px] font-black text-on-surface-variant/40 uppercase tracking-[0.4em] italic" data-v-acbde70c>Módulo de Administración Operativa</h2></div><h1 class="text-5xl font-black text-on-surface dark:text-white tracking-tighter uppercase italic leading-none" data-v-acbde70c> Centro de <span class="text-primary italic" data-v-acbde70c>Control</span></h1></div><div class="flex flex-wrap items-center gap-3 bg-white dark:bg-white/[0.02] p-2 rounded-[2rem] border border-outline-variant/10 shadow-xl" data-v-acbde70c>`);
			...
			_push(`</div></div><section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" data-v-acbde70c><!--[-->`);
			...
			_push(`<!--]--></section><div class="grid grid-cols-1 lg:grid-cols-12 gap-8" data-v-acbde70c>`);
			_push(ssrRenderComponent(Card_default, { class: "lg:col-span-8 !p-10 !rounded-[3.5rem] border border-outline-variant/10 dark:border-white/5 shadow-2xl dark:bg-[#0b0e14]" }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10" data-v-acbde70c${_scopeId}><div data-v-acbde70c${_scopeId}><h3 class="text-2xl font-black text-on-surface dark:text-white uppercase tracking-tighter italic leading-none" data-v-acbde70c${_scopeId}>Flujo de <span class="text-primary" data-v-acbde70c${_scopeId}>Capital</span></h3><p class="text-[10px] font-bold text-on-surface-variant/40 dark:text-white/20 uppercase tracking-[0.3em] mt-3 italic" data-v-acbde70c${_scopeId}>Indicadores de recaudo mensual vs facturación</p></div><div class="flex items-center gap-6 bg-surface-container-low dark:bg-white/5 px-6 py-3 rounded-2xl border border-outline-variant/10" data-v-acbde70c${_scopeId}><div class="flex items-center gap-2" data-v-acbde70c${_scopeId}><div class="w-2.5 h-2.5 rounded-full bg-primary shadow-[0_0_10px_rgba(0,97,255,0.5)]" data-v-acbde70c${_scopeId}></div><span class="text-[9px] font-black text-on-surface-variant dark:text-white/40 uppercase tracking-widest" data-v-acbde70c${_scopeId}>Recaudo</span></div><div class="flex items-center gap-2" data-v-acbde70c${_scopeId}><div class="w-2.5 h-2.5 rounded-full bg-error shadow-[0_0_10px_rgba(255,78,94,0.5)]" data-v-acbde70c${_scopeId}></div><span class="text-[9px] font-black text-on-surface-variant dark:text-white/40 uppercase tracking-widest" data-v-acbde70c${_scopeId}>Cartera</span></div></div></div><div class="h-80 -mx-4 group" data-v-acbde70c${_scopeId}>`);
			...
			_push(`<div class="lg:col-span-4 flex flex-col gap-8" data-v-acbde70c><div class="flex-1 bg-primary p-12 rounded-[3.5rem] relative overflow-hidden flex flex-col justify-between group cursor-pointer shadow-3xl shadow-primary/20 transition-all hover:scale-[1.02] border border-white/10" data-v-acbde70c><img class="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:scale-110 transition-transform duration-[3s]" src="https://images.unsplash.com/photo-1579546929518-9e396f3cc809?q=80&amp;w=2070" data-v-acbde70c><div class="relative z-10 space-y-4" data-v-acbde70c>`);
			...
			_push(`<h4 class="text-white text-3xl font-black tracking-tighter leading-tight italic uppercase" data-v-acbde70c>Optimización de <br data-v-acbde70c> Carteras</h4></div><div class="relative z-10 pt-8 border-t border-white/10 mt-8" data-v-acbde70c><p class="text-white/60 text-[10px] font-bold uppercase tracking-widest leading-relaxed" data-v-acbde70c>El recaudo aumentó un 22% este mes mediante cobros automáticos.</p>`);
			_push(ssrRenderComponent(Button_default, {
				variant: "ghost",
			...
			_push(ssrRenderComponent(Card_default, {
				...
				header: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="p-10 flex flex-col md:flex-row md:items-center justify-between gap-6" data-v-acbde70c${_scopeId}><div data-v-acbde70c${_scopeId}><h3 class="text-2xl font-black text-on-surface dark:text-white uppercase tracking-tighter italic leading-none" data-v-acbde70c${_scopeId}>Monitoreo de <span class="text-error" data-v-acbde70c${_scopeId}>Impagos</span></h3><p class="text-[10px] font-bold text-on-surface-variant/40 dark:text-white/20 uppercase tracking-[0.3em] mt-3 italic" data-v-acbde70c${_scopeId}>Registro técnico de unidades en estado de mora</p></div>`);
						_push(ssrRenderComponent(Button_default, {
							variant: "ghost",
							size: "sm",
							icon: "description",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(unref(Table), {
						...
						"cell-unit": withCtx(({ row }, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="text-lg font-black text-primary tracking-tighter italic" data-v-acbde70c${_scopeId}>Lote ${ssrInterpolate(row.unit)}</span>`);
						...
						"cell-owner": withCtx(({ row }, _push, _parent, _scopeId) => {
							if (_push) _push(`<div class="flex items-center gap-4 py-2" data-v-acbde70c${_scopeId}><div class="w-12 h-12 rounded-2xl bg-surface-container-high dark:bg-white/5 flex items-center justify-center text-xs font-black text-primary border border-outline-variant/10 shadow-sm relative overflow-hidden group" data-v-acbde70c${_scopeId}><div class="absolute inset-0 bg-primary/10 translate-y-full group-hover:translate-y-0 transition-transform duration-500" data-v-acbde70c${_scopeId}></div><span class="relative z-10" data-v-acbde70c${_scopeId}>${ssrInterpolate(row.initials)}</span></div><div class="flex flex-col" data-v-acbde70c${_scopeId}><span class="text-xs font-black text-on-surface dark:text-white uppercase italic tracking-tighter" data-v-acbde70c${_scopeId}>${ssrInterpolate(row.owner)}</span><span class="text-[9px] font-bold text-on-surface-variant/40 dark:text-white/20 uppercase tracking-widest" data-v-acbde70c${_scopeId}>PROPIETARIO VÁLIDO</span></div></div>`);
						...
						"cell-amount": withCtx(({ row }, _push, _parent, _scopeId) => {
							if (_push) _push(`<div class="flex flex-col" data-v-acbde70c${_scopeId}><span class="${ssrRenderClass([row.status_type === "error" ? "text-error" : "text-orange-500", "text-lg font-black tracking-tighter italic"])}" data-v-acbde70c${_scopeId}>${ssrInterpolate(formatCurrency(row.amount))}</span><span class="text-[8px] font-black text-on-surface-variant/40 dark:text-white/20 uppercase tracking-[0.2em] mt-1 italic" data-v-acbde70c${_scopeId}>SALDO VENCIDO</span></div>`);
						...
						"cell-actions": withCtx(({ row }, _push, _parent, _scopeId) => {
							if (_push) {
								_push(`<div class="flex justify-end gap-2 pr-6" data-v-acbde70c${_scopeId}>`);
...
var Dashboard_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Dashboard_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-acbde70c"]]);
//#endregion
