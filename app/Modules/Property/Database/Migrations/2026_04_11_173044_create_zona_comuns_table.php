...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('DROP TABLE IF EXISTS property.zonas_comunes CASCADE');

        Schema::create('property.zonas_comunes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('property.zonas_comunes');
    }
};
