...
{
    /** @use HasFactory<\App\Modules\Property\Database\Factories\CopropiedadFactory> */
    use HasFactory, HasUuids;

    protected static function newFactory()
    {
        return \App\Modules\Property\Database\Factories\CopropiedadFactory::new();
    }

    protected $table = 'property.copropiedades';
...
...
    ...
    public function featureEnabled(string $key): bool
    {
        ...
        // Handle deprecated key alias and new key interchangeably
        if ($key === 'asamblea_virtual_enabled' || $key === 'asamblea_virtual_active') {
            return (bool) ($this->settings['asamblea_virtual_active'] ?? false)
                || (bool) ($this->settings['asamblea_virtual_enabled'] ?? false)
                || (bool) ($defaults['asamblea_virtual_active'] ?? false);
        }
    ...
    {
        return $this->belongsToMany(User::class, 'property.admin_copropiedad', 'copropiedad_id', 'user_id');
    }
